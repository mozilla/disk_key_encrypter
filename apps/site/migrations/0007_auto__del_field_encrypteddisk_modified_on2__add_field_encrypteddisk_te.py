...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EncryptedDisk.modified_on2'
        db.delete_column('site_encrypteddisk', 'modified_on2')

        # Adding field 'EncryptedDisk.test'
        db.add_column('site_encrypteddisk', 'test',
                      self.gf('django.db.models.fields.CharField')(default='asdf', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EncryptedDisk.modified_on2'
        db.add_column('site_encrypteddisk', 'modified_on2',
