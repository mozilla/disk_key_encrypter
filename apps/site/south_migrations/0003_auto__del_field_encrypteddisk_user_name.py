...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EncryptedDisk.user_name'
        db.delete_column('site_encrypteddisk', 'user_name')


    def backwards(self, orm):
        # Adding field 'EncryptedDisk.user_name'
        db.add_column('site_encrypteddisk', 'user_name',
