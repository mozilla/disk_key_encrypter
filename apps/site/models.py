...
class EncryptedDisk(models.Model):
    ...
    encryption_type = models.ForeignKey('EncryptionType', verbose_name='System Type')
    created_on = models.DateTimeField(blank=True, null=True)
    updated_on = models.DateTimeField(blank=True, null=True)
    recovery_key = models.TextField(blank=False, null=False)
    binary_blob = models.FileField(upload_to='gpg', storage=DatabaseStorage(DBS_OPTIONS), blank=True, null=True, default=None)
